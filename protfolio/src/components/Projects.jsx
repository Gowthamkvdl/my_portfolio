      ...
      desc: (
        <>
          <ul>
            ...
            <li>Integrated <span className="fw-bold">OpenWeather API</span> for live weather updates with condition-based UI transitions.</li>
            <li>Implemented <span className="fw-bold">Bootstrap Modals</span> for city selection and a glassmorphic theme.</li>
            <li>Developed in <span className="fw-bold">React + TypeScript</span> for strong typing and reusable components.</li>
          </ul>
        </>
      ),
    ...
    <section className="py-5">
      <Container>
        ...
        <Row className="justify-content-center">
                  ...
                  <div className="d-flex justify-content-end">
                    ...
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        className="bi bi-code-slash me-1 pb-1" viewBox="0 0 16 16">
                    ...
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        className="bi bi-globe2 me-1 pb-1" viewBox="0 0 16 16">
          ...
          {/* COLLAPSE: SHOW REMAINING 3 PROJECTS */}
          <Collapse in={showAll}>
            <div>
              <Row>
                {projects.slice(3).map((p, idx) => (
                  <Col md={4} key={idx + 3} className="mb-3">
                    <Card
                      className="h-100 shadow-sm border-0"
                      onMouseEnter={() => setHoverIndex(idx + 3)}
                      onMouseLeave={() => setHoverIndex(null)}
                    >
                      <Card.Body>
                        <img
                          ...
                          style={{
                            transition: "transform 0.4s ease, filter 0.3s ease",
                            transform: hoverIndex === idx + 3 ? "scale(1.08)" : "scale(1)",
                            filter: hoverIndex === idx + 3 ? "brightness(1.1)" : "brightness(1)",
                            maxWidth: "100%",
                            height: "auto",
                            display: "block",
                            margin: "0 auto",
          ...
          <Col md={12} className="text-center mt-3">
            <Button
              ...
              target="_blank"
            >
              <FaGithub className="me-1 pb-1 fs-4" />
